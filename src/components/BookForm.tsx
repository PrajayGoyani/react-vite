...
const initialFormState: BookFormData = { id: '', name: '', author: '' }

function BookForm() {
  const addBook = useBookStore((state) => state.addBook)
  const [bookDetails, setBookDetails] = useState<BookFormData>(initialFormState)
  ...
  const handleAddBook = () => {
    ...
    addBook(bookDetails)
    setBookDetails(initialFormState)
  }
